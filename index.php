...
<head>
	<title>Organ Bank Donar Management System | Home Page</title>
			...
			<ul class="rslides callbacks callbacks1" id="slider4">
				<li>
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>Donor bank services that you
									<span>can trust</span>
								</h3>
				...
				<li>
					<div class="banner-top2">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>One Donor Donation Save One Lives
									<span>every day</span>
								</h3>
				...
				<li>
					<div class="banner-top3">
						...
						<!-- 		<h3>"Sometimes money cannot save life
									<span>but donated Donor can</span>
								</h3> -->
...
{ ?>
				<div class="col-md-4 pricing" style="margin-top:2%;">
					...
					<div class="price-bottom p-4">
						...
						<p class="card-text"><b>Donor Group :</b> <?php echo htmlentities($result->BloodGroup);?></p>
	...
	<div class="screen-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Donor GROUPS</h3>
				<span>
					<i class="fas fa-user-md"></i>
				</span>
				<p class="mt-2">Donor group of any human being will mainly fall in any one of the following groups..</p>
			</div>
			<div class="row">
            <div class="col-lg-6">
...
<li>AB positive or AB negative.</li>
                ...
                <p>A healthy diet helps ensure a successful Donor donation, and also makes you feel better! Check out the following recommended foods to eat prior to your donation.</p>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row mb-4">
            ...
            <h4 style="padding-top: 30px;">UNIVERSAL DONORS AND RECIPIENTS</h4>
                <p>
The most common Donor type is Eye, followed by type Kidney.

Type O individuals are often called "universal donors" since their Donor can be transfused into persons with any Donor type. Those with type AB Donor are called "universal recipients" because they can receive Donor of any type.</p>
            </div>
